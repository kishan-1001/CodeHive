...
=======
        <div className="mt-4">
>>>>>>> 7921f63afd76bb06565230a1adb8f5f4137e411b
          <div className="relative">
...
=======
          <div className="mt-3 grid grid-cols-2 gap-2">
            <button className="flex items-center justify-center px-3 py-2 border border-gray-600 rounded-lg text-gray-300 hover:bg-gray-800 transition-colors text-xs">
