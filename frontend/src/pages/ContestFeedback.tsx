...
import { arenaAPI } from '../services/api'; // We might need to extend or use raw fetch
...
const ContestFeedback: React.FC = () => {
                    ...
                    <div className="w-full">
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center justify-between">
                                ...
                                <button onClick={() => navigate('/weekly-contest')} className="text-sm text-gray-400 hover:text-white flex items-center gap-1 transition-colors">
                                ...
                                return (
                                    <div className="bg-gray-900 rounded-3xl border border-gray-800 overflow-hidden flex flex-col shadow-2xl">
                                        ...
                                        <div className="bg-gray-900/50 min-h-[600px] p-8">
                                            ...
                                            {(!problem.user_code || problem.user_code.trim() === '') ? (
                                                <div className="flex flex-col items-center justify-center h-64 text-center space-y-4 opacity-50 border border-dashed border-gray-700 rounded-2xl">
                                                    ...
                                                    <p className="text-gray-400 text-lg">No code submitted for analysis.</p>
                                                </div>
                                            ) : isAnalyzing ? (
