...
const DeleteProfileModal: React.FC<DeleteProfileModalProps> = ({ platformName, onClose, onConfirm }) => {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-gray-900 border border-red-500/30 rounded-2xl w-full max-w-md shadow-2xl relative overflow-hidden animate-in zoom-in-95 duration-200 ring-1 ring-red-500/20">
                ...
                <div className="p-8 text-center relative z-10">
                    ...
                    <h2 className="text-2xl font-bold text-white mb-2">Remove Profile?</h2>
                    ...
                    <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4 mb-8 text-left">
                        <div className="flex gap-3">
                            ...
                            <div className="text-sm text-red-200/80 leading-relaxed">
                                Are you sure you want to remove your <span className="font-bold text-red-400 capitalize">{platformName}</span> profile?
                                <br /><br />
                                This will <span className="font-bold text-red-400">unverify</span> it and remove its score from the global leaderboard.
                            </div>
                        </div>
                    </div>
